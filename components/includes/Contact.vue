    ...
    <form class="vue-form" @submit.prevent="submit">
      ...
      <fieldset>
        ...
        <div>
          ...
          <p class="select">
            <select v-model="reason" class="budget">
              <option value="" disabled selected>Choose One</option>
              <option value="Finding A Property Manager">
                Finding A Property Manager
              </option>
              <option value="Finding A Property">Finding A Property</option>
              <option value="Becoming A Property Manager">
                Becoming A Property Manager
              </option>
              <option value="Buying/Selling A Property">
        ...
        <div>
          <label class="label" for="textarea">Tell us your thoughts:</label>
          <textarea
            id="textarea"
            v-model="message"
            class="message"
        ...
        <div class="submit-container">
          <div v-if="loadingTxt" class="loading-text">
            Sending your message...
          </div>
          <div v-if="submitted" class="submitted-text">
            Success! Thank you for contacting Blue Key Property Mgmt!
          </div>
          <input
            :disabled="submitted"
            class="submit-button"
